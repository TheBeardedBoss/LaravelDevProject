<div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="/menu"><img src="assets/images/logo.svg" alt="logo" /></a>
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('viewMenuProducts')}}">
              ...
              <span class="menu-title">viewMenuProducts</span>
            </a>
          </li>
          
          <!-- Option to add products to menu in dashboard -->
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('menuProducts')}}">
              <span class="menu-icon">
                <i class="mdi mdi-file-document-box"></i>
              </span>
